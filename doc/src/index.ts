...
let ch = new ChangeSet([1, -1, 1, -1, 0, 1, 4, -1, 0, 3, 4, -1], [null, [{type: "addMark", mark: Emphasis.create()}], [Node.text("N")], null, [new CloseToken(Paragraph), new OpenToken(Paragraph.create()), Node.text("-")], null])
